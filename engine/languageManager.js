...
class LanguageManager {
      ...
      ru: {
        ...
        endings: {
          mind: {
            title: "БЕЗУМИЕ",
            description:
              "Ваш разум не выдержал давления. Логика и ясность покинули вас.",
          },
          heart: {
            title: "МОРАЛЬНЫЙ КОЛЛАПС",
            description:
              "Эмпатия и мораль исчезли. Вы потеряли связь с человечностью.",
          },
          time: {
            title: "ИСТОЩЕНИЕ",
            description:
              "Время и энергия закончились. Возможности упущены навсегда.",
          },
          drive: {
            title: "АПАТИЯ",
            description:
              "Амбиции и желание успеха угасли. Движение вперед остановилось.",
          },
          burnout: {
            title: "ВЫГОРАНИЕ",
          ...
          obsession: {
            title: "ОБСЕССИЯ",
            description:
              "Вы стали одержимы одной целью, потеряв все остальное.",
          },
          emptiness: {
            title: "ПУСТОТА",
        ...
        admin: {
          ...
          modeIndicator: "ADMIN MODE",
          exitButton: "Exit",
          difficultyTitle: "Difficulty Override",
          endingsTitle: "Force Endings",
          sceneTitle: "Scene Jump (Optional)",
          sceneIdPlaceholder: "Scene ID",
          jumpButton: "Jump to Scene",
          backButton: "Back",
        },
      },
      en: {
        ...
        endings: {
          mind: {
            title: "MADNESS",
            description:
              "Your mind could not withstand the pressure. Logic and clarity have left you.",
          },
          heart: {
            title: "MORAL COLLAPSE",
            description:
              "Empathy and morality have disappeared. You have lost connection with humanity.",
          },
          time: {
            title: "EXHAUSTION",
            description:
              "Time and energy have run out. Opportunities are lost forever.",
          },
          drive: {
            title: "APATHY",
            description:
              "Ambitions and desire for success have faded. Forward movement has stopped.",
          },
          burnout: {
            title: "BURNOUT",
            description:
              "You burned out trying to preserve everything at once.",
          },
          obsession: {
            title: "OBSESSION",
            description:
              "You became obsessed with one goal, losing everything else.",
          },
          emptiness: {
            title: "EMPTINESS",
            description:
              "You lost yourself trying to be everything to everyone.",
          },
          sacrifice: {
            title: "SACRIFICE",
            description:
              "You sacrificed yourself for others, but lost yourself.",
          },
        },
        insight: {
  ...
  getText(path) {
    ...
    // Попытка получить текст на текущем языке
    ...
    // Если нашли в русском
    if (typeof value === "string") {
      return value;
    }

    // Последний fallback - человекочитаемое сообщение или пустая строка
    // НИКОГДА не возвращаем raw key в production
    if (
      window.location.hostname === "localhost" ||
      window.location.hostname === "127.0.0.1"
    ) {
      // Только в dev режиме показываем key для отладки
      return `[MISSING: ${path}]`;
    }

    // В production - возвращаем пустую строку
    return "";
  }
